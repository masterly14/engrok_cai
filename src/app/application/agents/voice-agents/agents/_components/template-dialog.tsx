...
const templates: Template[] = [
  {
    ...
    description:
      "Una plantilla integral para resolver problemas de productos, responder preguntas y garantizar las experiencias satisfactorias de los clientes con el conocimiento técnico y la empatía.",
    icon: <Heart className="h-6 w-6" />,
    tags: ["Ventas", "Leads", "Conversión"],
    formData: {
      name: "Alex",
      firstMessage:
        "Hola, soy Alex de TechSolutions departamento de Atención al cliente. ¿Cómo puedo ayudarte hoy?",
  ...
  },
  {
    ...
    description:
      "Una plantilla consultiva diseñada para identificar prospectos calificados, comprender los desafíos del negocio y conectarlos con los representantes de ventas apropiados.",
    icon: <UserCheck className="h-6 w-6" />,
    tags: ["Calificación", "Leads", "Ventas"],
    formData: {
      name: "Juan",
      firstMessage:
        "Hola, te habla Juan de GrowthPartners. Ayudamos a las empresas a mejorar su eficiencia operativa mediante soluciones de software personalizadas. ¿Tienes unos minutos para conversar sobre cómo podríamos ayudar a tu negocio?",
...
`,
  ...
  },
  {
    ...
    description:
      "Una plantilla especializada para reservar, confirmar, reprogramar o cancelar citas de manera eficiente mientras proporciona información de servicio clara.",
    icon: <Calendar className="h-6 w-6" />,
    tags: ["Citas", "Calendario", "Agenda"],
    formData: {
      name: "Sofia",
      firstMessage:
        "Gracias por llamar a Wellness Partners. Soy Sofia, su asistente de programación. ¿Cómo puedo ayudarte hoy?",
  ...
  },
  {
    ...
    description:
      "Una plantilla metódica para recopilar información precisa y completa de los clientes al tiempo que garantiza la calidad de los datos y el cumplimiento regulatorio.",
    icon: <FileText className="h-6 w-6" />,
    tags: ["Encuestas", "Feedback", "Opiniones"],
    formData: {
      name: "Jamie",
      firstMessage:
        "Hola, habla Jamie de SecureConnect Insurance. Te llamo para ayudarte a completar tu solicitud. Esta llamada está siendo grabada para fines de calidad y precisión. ¿Es un buen momento para recopilar esta información?",
  ...
  },
  {
    ...
    description:
      "Una plantilla atractiva para realizar encuestas, recopilar comentarios de los clientes y recopilar investigación de mercado con altas tasas de finalización.",
    icon: <UserCheck className="h-6 w-6" />,
    tags: ["Onboarding", "Nuevos clientes", "Bienvenida"],
    formData: {
      name: "Cameron",
      firstMessage:
        "Hola, habla Cameron en nombre de QualityMetrics Research. Estamos realizando una breve encuesta sobre la satisfacción del cliente. Esto tomará aproximadamente 5 minutos y ayudará a mejorar nuestros servicios. ¿Estaría dispuesto(a) a participar hoy?",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-auto max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Puedes empezar desde cero o usar una de nuestras plantillas
            predefinidas para acelerar la creación de tu agente.
          </DialogDescription>
        </DialogHeader>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Crea tu agente completamente personalizado
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
