    ...
    const checkVapiStatus = async () => {
      ...
      try {
        ...
        if (response.status === 200 && response.workflow) {
          setVapiStatus(
            response.workflow.vapiWorkflowId ? "synced" : "not-synced",
          );
        } else {
          setVapiStatus("not-synced");
        }
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="text-xs text-gray-600 bg-gray-50 p-3 rounded-md">
              ...
              <p>
                Este workflow se sincronizará automáticamente con Vapi AI para
                su ejecución en llamadas de voz.
              </p>
            </div>
          </div>
          <DialogFooter>
