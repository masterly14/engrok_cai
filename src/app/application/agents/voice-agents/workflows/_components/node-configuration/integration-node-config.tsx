...
export function IntegrationNodeConfig({
  ...
  const handleIntegrationSelect = (
    integrationType: IntegrationNodeData["integrationType"],
  ) => {
    const baseData = {
  ...
  const selectedIntegrationConfig = integrations.find(
    (int) => int.id === nodeData.integrationType,
  );
  ...
  return (
    <div className="flex flex-col gap-6 p-6 bg-gray-50/50 rounded-lg">
          ...
          <Button
            ...
            onClick={() =>
              handleIntegrationSelect(
                integration.id as IntegrationNodeData["integrationType"],
              )
            }
            className={`
      ...
      {selectedIntegrationConfig?.providerConfigKey &&
        selectedIntegrationConfig?.authMode && (
