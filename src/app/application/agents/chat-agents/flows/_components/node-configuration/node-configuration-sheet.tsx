...
export function NodeConfigurationSheet({
  ...
  const wrappedUpdateNode = React.useCallback(
  ...
  const nodeFriendlyName =
    nodeTypeToNameMap[selectedNode.type || ""] || selectedNode.type || "Node";
      ...
      default:
        return (
          <div className="p-6 text-center text-gray-500">
            ...
            <p className="text-sm">
              Este tipo de nodo no tiene configuraciones específicas.
            </p>
          </div>
        );
    }
  ...
  return (
    ...
    >
      <SheetContent
        side="right"
        className="w-auto sm:max-w-4xl flex flex-col p-0 overflow-y-auto"
      >
        <SheetHeader className="p-6 border-b border-gray-200">
          <SheetTitle className="text-lg font-semibold text-gray-900">
            Configure {nodeFriendlyName}
          </SheetTitle>
          <SheetDescription className="text-sm text-gray-500">
            Ajusta las configuraciones para el nodo '
