  ...
  return (
    <div className="bg-green-500 p-4 rounded-lg shadow-md w-64 text-white border-2 border-green-600">
      <div className="flex items-center mb-2">
        ...
        <strong className="text-sm truncate" title={data.name || "Capturar respuesta"}>
          {data.name || "Capturar respuesta"}
        </strong>
      </div>
      <p className="text-xs opacity-80 truncate" title={data.variableName || "Configurar variable..."}>
