...
const industries = [
  {
    ...
    name: "Fintech",
    description:
      "Automatiza recordatorios de pago, verifica la identidad de clientes y ofrece soporte 24/7 sobre productos financieros.",
  ...
  },
  {
    ...
    name: "Salud",
    description:
      "Confirma citas, envía recordatorios de medicación y resuelve preguntas frecuentes, liberando al personal para atención crítica.",
    benefits: [
  ...
  },
  {
    ...
    name: "Educación",
    description:
      "Gestiona inscripciones, envía notificaciones académicas y ofrece soporte a estudiantes a cualquier hora del día.",
    benefits: [
      "Automatiza admisiones",
      "Comunicación masiva",
      "Soporte estudiantil 24/7",
    ],
  ...
  },
  {
    ...
    name: "E-commerce",
    description:
      "Recupera carritos abandonados, confirma pedidos, gestiona devoluciones y ofrece soporte post-venta de forma automática.",
    benefits: [
      "Recupera ventas +20%",
  ...
  },
  {
    ...
    name: "Inmobiliaria",
    description:
      "Califica leads, agenda visitas y da seguimiento a clientes potenciales de forma instantánea y personalizada.",
    benefits: [
  ...
  },
  {
    ...
    name: "Agencias",
    description:
      "Ofrece servicios de automatización a tus clientes y gestiona múltiples cuentas desde una sola plataforma.",
    benefits: [
      "Nuevo flujo de ingresos",
      "Gestiona multi-cliente",
      "Servicios de IA",
    ],
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-white/60 font-light max-w-3xl mx-auto leading-relaxed tracking-wide">
            Desde startups hasta grandes corporaciones, KarolAI impulsa la
            comunicación inteligente en cada sector.
          </p>
        </div>
          ...
          {industries.map((industry, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                {/* Icon */}
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${industry.gradient} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
