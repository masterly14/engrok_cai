...
const testimonials = [
  {
    ...
    content: "Implementamos KarolAI y automatizamos el 80% de nuestras consultas por WhatsApp. Nuestro equipo ahora se enfoca en cierres de ventas. Increíble.",
    rating: 5,
  ...
  },
  {
    ...
    image: "/placeholder.svg",
    content: "El constructor de flujos nos permitió crear un agente de voz para calificación de leads que funciona 24/7. La calidad de las voces es impresionante.",
    rating: 5,
  ...
  },
  {
    ...
    company: "ModaFly",
    image: "/placeholder.svg",
    content: "Las campañas de WhatsApp son un cambio de juego. Alcanzamos a miles de clientes en minutos con mensajes personalizados y relevantes.",
    rating: 5,
  ...
  return (
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/3 right-1/3 w-[400px] h-[400px] bg-gradient-to-l from-purple-500/4 to-pink-500/4 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-black/60 font-light max-w-2xl mx-auto leading-relaxed tracking-wide">
            Líderes de la industria comparten cómo KarolAI revolucionó la comunicación con sus clientes.
          </p>
        </div>
            ...
            <div className="bg-black/[0.015] backdrop-blur-xl border border-black/8 rounded-3xl p-12 relative overflow-hidden">
              ...
              <div className="flex items-center justify-center space-x-6">
                ...
                <div className="text-center">
                  <div className="text-black font-light text-lg">{testimonials[currentIndex].name}</div>
                  <div className="text-black/60 text-sm">{testimonials[currentIndex].role}</div>
                  <div className="text-cyan-400 text-sm font-mono">{`en ${testimonials[currentIndex].company}`}</div>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-light text-cyan-400">{testimonials[currentIndex].metrics}</div>
                  <div className="text-black/40 text-xs uppercase tracking-wider">Mejora</div>
                </div>
              </div>
            </div>
          </div>
