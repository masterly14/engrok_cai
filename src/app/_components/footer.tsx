        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-16">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mb-8 max-w-md leading-relaxed font-light tracking-wide text-black/60">
              Redefiniendo los límites de la inteligencia artificial. Precisión,
              innovación y futuro en cada interacción.
            </p>
          ...
          <div className="lg:col-span-6 lg:col-start-7">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
              <div>
                <h3 className="font-light text-sm tracking-wider uppercase mb-6 text-black/40">
                  Producto
                </h3>
                <ul className="space-y-4">
                  {["Características", "Precios", "Integraciones", "API"].map(
                    (item) => (
                      <li key={item}>
                        <a
                          href="#"
                          className="text-black/60 hover:text-black transition-colors duration-300 font-light text-sm tracking-wide flex items-center group"
                        >
                          {item}
              ...
              <div>
                ...
                <ul className="space-y-4">
                  {["Documentación", "Estado", "Comunidad", "Ayuda"].map(
                    (item) => (
                      <li key={item}>
                        <a
                          href="#"
            ...
            <div className="flex space-x-8 text-sm">
              {["Privacidad", "Términos", "Cookies"].map((item) => (
                <a
                  key={item}
                  href="#"
                  className="text-black/40 hover:text-black/60 transition-colors duration-300 font-light tracking-wide"
                >
                  {item}
                </a>
              ))}
