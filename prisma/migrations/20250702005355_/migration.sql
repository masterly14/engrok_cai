/*
  ...
  - You are about to drop the column `active` on the `Workflow` table. All the data in the column will be lost.
  - You are about to drop the column `fields` on the `Workflow` table. All the data in the column will be lost.
  - You are about to drop the column `vapiWorkflowData` on the `Workflow` table. All the data in the column will be lost.
  - You are about to drop the column `vapiWorkflowId` on the `Workflow` table. All the data in the column will be lost.
  - You are about to drop the `ElevenLabsWidget` table. If the table is not empty, all the data it contains will be lost.
...
-- DropIndex
DROP INDEX "Workflow_vapiWorkflowId_key";

-- AlterTable
ALTER TABLE "ChatAgent" ADD COLUMN     "activeWorkflowId" UUID;

-- AlterTable
ALTER TABLE "Workflow" DROP COLUMN "active",
DROP COLUMN "fields",
DROP COLUMN "vapiWorkflowData",
DROP COLUMN "vapiWorkflowId";

-- DropTable
DROP TABLE "ElevenLabsWidget";
