...
const tools = [
  {
    name: 'createLead',
    description: 'Crea un nuevo lead en el CRM cuando se obtiene información de contacto del usuario.',
  ...
  },
  {
    ...
    description: 'Consulta la disponibilidad en el calendario para agendar una cita o demostración.',
    ...
    parameters: {
      ...
      properties: {
        date: {
          type: 'string',
          description: 'La fecha para la cual se quiere consultar la disponibilidad, en formato YYYY-MM-DD.',
        },
      },
      required: ['date'],
    },
  ...
  {
    name: 'createEvent',
    description: 'Agenda un nuevo evento, cita o demostración en el calendario.',
    provider: 'google-calendar',
    parameters: {
      type: 'object',
      properties: {
        ...
        startTime: {
          type: 'string',
          description: 'Fecha y hora de inicio del evento en formato ISO 8601 (ej: 2024-07-08T10:00:00-05:00).',
        },
        endTime: {
          type: 'string',
          description: 'Fecha y hora de fin del evento en formato ISO 8601 (ej: 2024-07-08T11:00:00-05:00).',
        },
        attendeeEmail: {
          type: 'string',
